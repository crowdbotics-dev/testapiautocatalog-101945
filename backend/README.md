...
## Project Structure
    ...
    ├── testapiautocatalog_101945  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_101945`
...
2. Clone this repo and `cd testapiautocatalog_101945`
